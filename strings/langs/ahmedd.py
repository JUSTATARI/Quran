...
call_4 : "<b>⌔︙ يرجى الانتظار .</b>\n<b>⌔︙ جارِ دعوة مساعد {0} إلى المجموعة...</b>"
...
admin_2 : "<b>⌔︙ تم إيقاف البث مؤقتاً 🥢\n\n<b>⌔︙ بواسطة : {0} .</b>"
admin_3 : "هل تذكر أنك قمت بإيقاف البث؟"
admin_4 : "<b>⌔︙ تم استئناف البث 🥢</b>\n\n<b>⌔︙ بواسطة : {0} .</b>"
admin_5 : "<b>⌔︙ تم إيقاف البث 🥢</b>\n\n<b>⌔︙ بواسطة : {0} .</b>"
admin_6 : "<b>⌔︙ تم تخطي البث 🥢</b>\n<b> بواسطة : {0} .</b>\n<b>⌔︙ لا يوجد قائمة انتظار في</b> {1}.\n<b>⌔︙ سأغادر المكالمه حالياً </b>"
...
admin_13 : "⌔︙ يرجى إعادة تحميل ذاكرة التخزين المؤقت للمشرف عبر: (ريلود)"
admin_14 : "⌔︙ ليس لديك صلاحيات لإدارة دردشات الفيديو.\n\nيرجى إعادة تحميل ذاكرة التخزين المؤقت للمشرف عبر: (ريلود)"
...
admin_17 : "<b>مثال:</b>\n\n<code>تكرار تفعيل</code>/<code>تكرار تعطيل</code>\nتكرار <code>10</code>/<code>9</code>/<code>8</code>/<code>7</code>"
admin_18 : "⌔︙ تم تفعيل الحلقة لعدد <code>{0}</code> مرات بواسطة: {1}."
...
admin_41 : "** عذرآ مكتوم من قبل **"
admin_42 : "** تم كتم الصوت بواسطة \n\n: {} **"
admin_43 : "** تمت إعادة التشغيل بالفعل **"
admin_44 : "** رائع تم الاعاده بنجاح \n\n بواسطه : {} **"

start_1 : "⌔︙البوت {0} يعمل بنجاح\n\n<b>⌔︙وقت التشغيل :</b> {1}"
start_2 : "<b>⌔︙اهلا عزيزي ↬</b> {0}\n<b>⌔︙انا بوت اسمي ↬</b> {1}\n<b>⌔︙تخصصي تشغيل الميوزك في المكالمات</b>\n\n<b><u>⌔︙منصات التشغيل المدعومة :</b></u>\nيوتيوب - سبوتيفاي - ريسو ميوزك - ابل ميوزك - ساوند كلاود\n⌔︙لـ اظهلر كيبورد التسلية ↬ ⦗ /cmds ⦘\n– – – – – – – – – – – – – – – – – –\n<b>⌔︙لرؤية الاوامر اضغط اوامر البوت</b>"
start_4 : "<b>⌔︙ مطلوب مجموعة خارقه ...</b>\n\n<b>⌔︙ يرجى تحويل المجموعة الخاصة بك إلى خارقه ثم أضفني مرة </b>\n\n<b>⌔︙ كيفية جعلها خارقه :</b>\n⌔︙ اجعل سجل الدردشة الخاصة بمجموعتك <b>مرئيًا</b> مرة واحدة"
...
queue_4 : "⦿ <b>تم إضافته إلى قائمة الانتظار في الموقع رقم #{0}</b>\n\n◕<b> العنوان :</b> {1}\n◕<b> المدة :</b> {2} دقيقة\n◕<b> طلب بواسطة :</b> {3}"
...
queue_7 : "\nانقر على الزر أدناه للحصول على قائمة الانتظار بالكامل."
queue_8 : "<b>⌔︙ مشغل {0}</b>\n\n<b>⌔︙جارِ البث حاليًا ل :</b> {1}\n\n🔗 <b>⌔︙ نوع البث :</b> {2}\n<b>⌔︙ طلب بواسطة :</b> {3}\n{4}"

stream_1 : "⌔︙<b> جارِ التشغيل الان </b>𝄞\n\n◕<b> العنوان :</b> <a href={0}>{1}</a>\n◕<b> المدة :</b> {2} دقيقة\n◕<b> طلب بواسطة :</b> {3}"
stream_2 : "⌔︙<b>جارِ التشغيل الان </b>𝄞\n\n◕<b> نوع التشغيل :</b> بث مباشر [الرابط]\n◕<b> طلب بواسطة :</b> {0}"
...
help_2 : "⌔︙ انقر على الزر أدناه لتصفح الاوامر في خاص البوت"

lang_1 : "⌔︙ يُرجى اختيار اللغة التي ترغب في تعيينها كلغة افتراضية لهذه المجموعة:"
lang_2 : "⌔︙تم تغيير اللغة"
...
setting_10 : "⌔︙ تم تعطيل وضع التصويت بنجاح ✅"
...
set_cb_1 : "جارٍ الحصول على لوحة مستخدمي المسموح لهم..."
set_cb_2 : "جارٍ الحصول على لوحة وضع التشغيل..."
set_cb_3 : "جاري تغيير الإعدادات..."
set_cb_4 : "⌔︙ جاري الحصول على قائمة المستخدمين المسموح لهم..."
...
play_22 : "حدد الوضع الذي تريد تشغيل الاشعارات به داخل مجموعتك: {0}"

str_1 : "يرجى تقديم روابط m3u8 أو index."
str_2 : "⌔︙ تم التحقق من البث\n\n⌔︙ جارِ المعالجة ."
str_3 : "⌔︙ فشل في البث المباشر من يوتيوب ❌\n⌔︙ لم يتم العثور على تنسيق بث مباشر ؟!"

ping_1 : "⌔︙ جارِ فحص البينج ل {0} ."
ping_2 : "<b>⌔︙ البنج :</b> <code>{0}ms</code>\n\n<b><u>{1} إحصائيات النظام :</u></b>\n\n<b>⌔︙ وقت التشغيل :</b> {2}\n<b>⌔︙ الذاكرة العشوائية (RAM) :</b> {3}\n<b>⌔︙ المعالج (CPU) :</b> {4}\n<b>⌔︙ القرص الصلب (Disk) :</b> {5}\n<b>⌔︙ المكتبة (Py⌔︙TgCalls) :</b> <code>{6}ms</code>"
...
CLOSE_BUTTON : "‹ إغلاق ›"
BACK_BUTTON : "‹ رجوع ›"
MATRIX_BUTTON : "‹ 𝖲𝗈𝗎𝗋𝖼𝖾 𝖺𝖳𝖺𝗋𝗂 ›"

S_B_1 : "‹ اضفني لمجموعتك ›"
S_B_3 : "‹ اضفني لمجموعتك ›"
S_B_4 : "‹ اوامر البوت › "
S_B_5 : "المطور"
S_B_6 : "‹ قناة السورس ›"
...
#Playlist
PL_B_1 : "‹ تشغيل محفوظاتك ›"
PL_B_2 : "‹ التحكم انلاين ›"
PL_B_3 : "‹ التحكم بالتشغيل ›"
PL_B_33 : "‹ حفظ التشغيل ›"
PL_B_5 : "‹ حذف الكل ›"
PL_B_6 : "‹ حذف قائمة تشغيلك ›"
PL_B_7 : "اي أنا متأكد. احذفه"
...
sudo_5 : "<u><b>مبرمج السورس لـ البوت :</b></u>\n"
sudo_6 : "\n<b>⌔︙قائمة مبرمجين السورس :</b>\n"
...
maint_1 : "<b>⌔︙ مثال :</b>\nالصيانه [تفعيل | تعطيل]"
maint_2 : "⌔︙ تم تفعيل وضع الصيانة {0}."
maint_3 : "⌔︙ تم تعطيل وضع الصيانة {0}."
maint_4 : "⌔︙ وضع الصيانة مُمكّن بالفعل."
maint_5 : "⌔︙ وضع الصيانة مُعطّل بالفعل."

log_1 : "<b>⌔︙ مثال :</b>\nالسجل [تفعيل | تعطيل]"
log_2 : "تم تفعيل تسجيل البيانات."
log_3 : "تم تعطيل تسجيل البيانات."

broad_1 : "⌔︙ جارِ الاذاعة..."
broad_2 : "<b>⌔︙ مثال :</b>\n\nاذاعه [الرسالة أو بالرد على رسالة]"
broad_3 : "⌔︙ تمت الاذاعة إلى {0} دردشة مع {1} تثبيتًا من البوت."
broad_4 : "⌔︙ تم الاذاعة إلى {0} مستخدمين."
broad_5 : "⌔︙ بدء اذاعة المساعد..."
broad_6 : "⌔︙ اذاعة المساعد :\n\n"
broad_7 : "⌔︙ تم اذاعة المساعد {0} في {1} دردشة."
broad_8 : "⌔︙ يُرجى تقديم نص ل الاذاعة ..."

server_1 : "⌔︙ فشل في الحصول على السجلات."
server_2 : "⌔︙ يرجى التأكد من فار كود مفتاح API هيروكو الخاص بك واسم التطبيق بشكل صحيح"
...
server_12 : "<b>جارِ حساب سرعة التنزيل</b>"
server_13 : "<b>جارِ حساب سرعة الرفع...</b>"
server_14 : "<b>مشاركة نتائج اختبار السرعة...</b>"
server_15 : "⌔︙<b>نتائج اختبار السرعة</b>\n\n<u><b>العميل :</b></u>\n<b>⌔︙ عنوان IP :</b> {0}\n<b>⌔︙ البلد :</b> {1}\n\n<u><b>الخادم :</b></u>\n<b>⌔︙ الاسم :</b> {2}\n<b>⌔︙ البلد :</b> {3}, {4}\n<b>⌔︙ الراعي :</b> {5}\n<b>⌔︙ التأخير :</b> {6}\n<b>⌔︙ التأخير في الشبكة :</b> {7}"
gban_1 : "⌔︙ لماذا تريد حظر نفسك"
gban_2 : "⌔︙ لماذا يجب أن أحظر نفسي؟"
gban_3 : "⌔︙ لا يمكنك حظر المستخدمين المسموح لهم."
...
gban_12 : "<b>قائمة المستخدمين المحظورين عام :</b>\n\n"